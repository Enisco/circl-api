...
export const PEOPLE: SeedPerson[] = [
  {
    ...
    interests: ['JOB_SEARCH', 'FOOD_COOKING', 'UNIVERSITY_STUDY', 'MUSIC', 'TRAVEL'],
  ...
  },
  {
    ...
    interests: ['UNIVERSITY_STUDY', 'TECH', 'GAMING', 'SPORT_FITNESS'],
  ...
  },
  {
    ...
    heritageTag: 'WEST_AFRICAN',
    journeyStage: 'ESTABLISHED',
    interests: ['JOB_SEARCH', 'BUSINESS_SETUP', 'FAITH_COMMUNITY', 'READING', 'CHILDREN_FAMILY'],
    languages: ['ENGLISH', 'YORUBA'],
  ...
  },
  {
    ...
    heritageTag: 'SOUTH_ASIAN',
    journeyStage: 'ESTABLISHED',
    interests: ['LANGUAGE_HELP', 'ART_CULTURE', 'FILM_TV', 'READING', 'VOLUNTEERING', 'FOOD_COOKING'],
  ...
  },
  {
    ...
    journeyStage: 'ESTABLISHED',
    interests: ['VOLUNTEERING', 'FOOD_COOKING', 'FAITH_COMMUNITY', 'CHILDREN_FAMILY', 'BUSINESS_SETUP', 'READING', 'ART_CULTURE'],
    languages: ['ENGLISH'],
  ...
  },
  {
    ...
    heritageTag: 'WEST_AFRICAN',
    journeyStage: 'ESTABLISHED',
    interests: ['FOOD_COOKING', 'BUSINESS_SETUP', 'FASHION_BEAUTY', 'MUSIC', 'FAITH_COMMUNITY'],
  ...
  },
  {
    ...
    journeyStage: 'ESTABLISHED',
    interests: ['SPORT_FITNESS', 'LANGUAGE_HELP', 'OUTDOORS', 'TRAVEL', 'FILM_TV', 'GAMING'],
  ...
  },
  {
    ...
    journeyStage: 'SETTLING_IN',
    interests: ['OUTDOORS', 'CHILDREN_FAMILY', 'MUSIC', 'TRAVEL', 'FAITH_COMMUNITY'],
