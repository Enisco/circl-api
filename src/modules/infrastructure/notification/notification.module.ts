...
@Module({
  ...
  // FcmService is exported because messaging pushes directly (5.6): the socket decides per recipient whether a message needs a push, which is a decision only that path can make.
