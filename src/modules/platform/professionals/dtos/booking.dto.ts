...
export class CreateBriefDto {
  ...
  @IsEnum(BriefUrgency) @IsOptional()
...
export class CreateBookingDto {
  ...
  @ApiPropertyOptional() @Trim() @IsString() @MaxLength(80) @IsOptional()
  ...
  @Trim() @IsString() @MaxLength(2000) @IsOptional()
  details?: string;
...
export class ListBookingsDto extends PageOptionsDto {
  ...
  @IsIn(['CLIENT', 'PROFESSIONAL']) @IsOptional()
...
export class CreateDisputeDto {
  ...
  @Trim() @IsString() @MinLength(20) @MaxLength(4000)
  description: string;
...
export class ManagedRequestDto {
  ...
  @IsArray() @ArrayMaxSize(6) @IsOptional()
  helpAreas?: string[];
